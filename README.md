...
``` sh
git submodule add git://github.com/octothemes/murky-mussels.git .themes/murky-mussels
```
...
If you are more comfortable with just the theme files, you can download our zip archives from [S3](https://s3.amazonaws.com/static.octopressthemes.com/themes/murky-mussels-v0.1.3.zip).
...
1. Download the new packages from [S3](https://s3.amazonaws.com/static.octopressthemes.com/themes/murky-mussels-v0.1.3.zip).
...
[submodule ".themes/murky-mussels"]
  ...
  url = https://github.com/octothemes/murky-mussels.git
```
